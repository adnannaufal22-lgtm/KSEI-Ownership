...
The interface uses a responsive, information-dense capital-markets terminal layout with native Streamlit controls and interactive Plotly charts. The presentation layer is separate from the existing BEI data-loading and ownership-calculation logic.
